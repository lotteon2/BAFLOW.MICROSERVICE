...
public class SocialAuthRestController {
  ...
  public ResponseEntity<UserLoginResponse> loginWithUserServiceResponse(
      @RequestBody SocialUserLoginCommand dto) {
    UserLoginResponse userLoginResponse = userDataRequest.request(dto);
