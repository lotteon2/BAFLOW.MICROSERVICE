...
public class ExceptionHandlerFilter extends OncePerRequestFilter {
  ...
  public void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      ...
      JsonBinderUtil.setResponseWithJson(response, 401, createDtoByToken(e));
    }
    ...
    private AccessTokenExpiredResponse createDtoByToken (ExpiredJwtException e){
      return AccessTokenExpiredResponse.builder()
          .id(Long.valueOf(e.getClaims().getSubject()))
